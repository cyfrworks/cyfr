...
const ALL_PROVIDERS: &[Provider] = &[
    Provider { key: "claude",     registry_ref: "catalyst:local.claude"     },
    Provider { key: "openai",     registry_ref: "catalyst:local.openai"     },
    Provider { key: "gemini",     registry_ref: "catalyst:local.gemini"     },
    Provider { key: "grok",       registry_ref: "catalyst:local.grok"       },
    Provider { key: "openrouter", registry_ref: "catalyst:local.openrouter" },
];
