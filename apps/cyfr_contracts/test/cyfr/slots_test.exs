...
defmodule Cyfr.SlotsTest do
  ...
  describe "configuration" do
    ...
    test "the authority depth cap fits inside the default child reserve" do
      ...
      assert Cyfr.Authority.depth_cap() <= Slots.child_reserve(Slots.default_max())
      assert Slots.max_key_footprint(16) == 16 * Cyfr.Authority.depth_cap()
    end
