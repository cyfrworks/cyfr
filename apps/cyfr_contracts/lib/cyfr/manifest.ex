...
defmodule Cyfr.Manifest do
  @moduledoc """
  Decoding a stored component manifest.

  Normalizes manifest values from their storage representations (nil, JSON
  string, map) into a map. What a decoded manifest may declare, and the one
  validator a write boundary runs, is `Compendium.Manifest`.
  """
