...
defmodule Cyfr.ComponentNamespace do
  @moduledoc """
  ...
  publisher's (`Cyfr.ComponentPath.local_publisher?/1`).

  ## Examples

      iex> Cyfr.ComponentNamespace.require_local_guest_write("local")
      :ok

      iex> Cyfr.ComponentNamespace.require_local_guest_write("acme")
  ...
  def require_local_guest_write(publisher) do
    if Cyfr.ComponentPath.local_publisher?(publisher),
      do: :ok,
