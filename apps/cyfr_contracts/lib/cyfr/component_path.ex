...
defmodule Cyfr.ComponentPath do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> Cyfr.ComponentPath.default_publisher()
      "local"
  ...
  ## Examples
      ...
      iex> Cyfr.ComponentPath.normalize_publisher(nil)
      "local"

      iex> Cyfr.ComponentPath.normalize_publisher("moonmoon69")
      "moonmoon69"
  ...
  ## Examples
      ...
      iex> Cyfr.ComponentPath.local_publisher?("local")
      true

      iex> Cyfr.ComponentPath.local_publisher?("moonmoon69")
      false

      iex> Cyfr.ComponentPath.local_publisher?(nil)
      true
  ...
  ## Examples
      ...
      iex> Cyfr.ComponentPath.type_plural("catalyst")
      "catalysts"
  ...
  ## Examples
      ...
      iex> Cyfr.ComponentPath.singular("catalysts")
      "catalyst"
  ...
  ## Examples
      ...
      iex> Cyfr.ComponentPath.version_dir("tincture", nil, "widget", "1.0.0")
