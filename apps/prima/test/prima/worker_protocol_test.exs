...
defmodule Prima.WorkerProtocolTest do
  @moduledoc """
  ...
  alias Prima.{Assignment, HostAPI, WorkerAPI, WorkerAuth}
  ...
  test "the wire's bounds are the shared limits" do
    assert HostAPI.max_body_bytes() == Prima.Limits.default_max_request_size()
    assert HostAPI.max_answer_bytes() == Prima.Limits.default_max_response_size()
