...
defmodule Prima.ModelTest do
  ...
  # Synchronous: one test asserts the log stays empty, and `capture_log/1`
  # reads every process's log, so a concurrent test's warning would land in it.
