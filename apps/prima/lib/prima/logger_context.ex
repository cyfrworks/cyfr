...
defmodule Prima.LoggerContext do
  @moduledoc """
  ...
  `Cyfr.LoggerRosterTest` binds the two together, and `Prima.JsonFormatter`
  falls back to it.
  ...
  ## Usage
      ...
      metadata = Prima.LoggerContext.capture()
      Task.Supervisor.start_child(MySupervisor, fn ->
        Prima.LoggerContext.restore(metadata)
        # ... task work ...
      end)
  """
  def capture do
