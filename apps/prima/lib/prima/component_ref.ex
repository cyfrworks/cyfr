...
defmodule Prima.ComponentRef do
  @moduledoc """
  ...
  **Shorthand**: `c` = catalyst, `r` = reagent, `f` = formula, `t` = tincture
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.parse("catalyst:local.my-tool:1.0.0")
      {:ok, %Prima.ComponentRef{type: "catalyst", namespace: "local", name: "my-tool", version: "1.0.0"}}

      iex> Prima.ComponentRef.parse("c:local.my-tool")
      {:ok, %Prima.ComponentRef{type: "catalyst", namespace: "local", name: "my-tool", version: nil}}

      iex> Prima.ComponentRef.parse("c:stripe.com.api:0.1.0")
      {:ok, %Prima.ComponentRef{type: "catalyst", namespace: "stripe.com", name: "api", version: "0.1.0"}}
  """
  ...
  ## Examples
      ...
      iex> ref = %Prima.ComponentRef{type: "catalyst", namespace: "local", name: "my-tool", version: "1.0.0"}
      iex> Prima.ComponentRef.to_string(ref)
      "catalyst:local.my-tool:1.0.0"

      iex> ref = %Prima.ComponentRef{type: "catalyst", namespace: "local", name: "my-tool", version: nil}
      iex> Prima.ComponentRef.to_string(ref)
  ...
  Builds type:namespace.name references with an optional :version suffix.
      ...
      iex> Prima.ComponentRef.build("tincture", "acme", "docs")
      "tincture:acme.docs"

      iex> Prima.ComponentRef.build("reagent", "local", "fetch", "1.2.0")
  ...
  **required** — untyped refs are rejected with a helpful error message.
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.normalize("catalyst:local.my-tool:1.0.0")
      {:ok, "catalyst:local.my-tool:1.0.0"}

      iex> Prima.ComponentRef.normalize("c:local.my-tool:1.0.0")
      {:ok, "catalyst:local.my-tool:1.0.0"}

      iex> Prima.ComponentRef.normalize("local.my-tool:1.0.0")
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.normalize_flexible("c:local.my-tool:1.0.0")
      {:ok, %Prima.ComponentRef{type: "catalyst", namespace: "local", name: "my-tool", version: "1.0.0"}}

      iex> Prima.ComponentRef.normalize_flexible("c:local.my-tool")
      {:ok, %Prima.ComponentRef{type: "catalyst", namespace: "local", name: "my-tool", version: nil}}

      iex> Prima.ComponentRef.normalize_flexible("local.my-tool:1.0.0")
      {:error, "component ref must include a type prefix (e.g., catalyst:local.my-tool:1.0.0 or c:local.my-tool:1.0.0). Valid types: catalyst (c), reagent (r), formula (f), tincture (t)"}
  """
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.normalize_or_name_ref("c:local.claude:0.1.0")
      {:ok, "catalyst:local.claude:0.1.0"}

      iex> Prima.ComponentRef.normalize_or_name_ref("c:local.claude")
      {:ok, "catalyst:local.claude"}

      iex> Prima.ComponentRef.normalize_or_name_ref("not valid")
      {:error, _}
  """
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.pinned?(%Prima.ComponentRef{namespace: "local", name: "claude", version: "0.1.0"})
      true

      iex> Prima.ComponentRef.pinned?(%Prima.ComponentRef{namespace: "local", name: "claude", version: nil})
      false
  """
  ...
  ## Examples
      ...
      iex> ref = %Prima.ComponentRef{type: "catalyst", namespace: "local", name: "claude", version: "0.1.0"}
      iex> Prima.ComponentRef.to_name_ref(ref)
      "catalyst:local.claude"

      iex> Prima.ComponentRef.to_name_ref("catalyst:local.claude:0.1.0")
      {:ok, "catalyst:local.claude"}
  """
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.validate("catalyst:local.my-tool:1.0.0")
      :ok

      iex> Prima.ComponentRef.validate("")
      {:error, "component ref cannot be empty"}
  """
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.validate_type("catalyst")
      :ok

      iex> Prima.ComponentRef.validate_type("invalid")
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.valid_types()
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.valid_type_atoms()
      [:catalyst, :reagent, :formula, :tincture]
  """
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.executable_types()
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.expand_type_shorthand("c")
      "catalyst"

      iex> Prima.ComponentRef.expand_type_shorthand("catalyst")
      "catalyst"
  """
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.source_types()
      ["agent"]
  """
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.validate_namespace("local")
      :ok

      iex> Prima.ComponentRef.validate_namespace("alice")
      :ok

      iex> Prima.ComponentRef.validate_namespace("stripe.com")
      :ok
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.validate_publisher("cyfr")
      :ok

      iex> Prima.ComponentRef.validate_publisher("stripe.com")
      :ok
  """
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.validate_name("my-tool")
      :ok

      iex> Prima.ComponentRef.validate_name("MY_CAPS")
  ...
  ## Examples
      ...
      iex> Prima.ComponentRef.validate_version("1.0.0")
      :ok

      iex> Prima.ComponentRef.validate_version(nil)
  ...
  defimpl String.Chars do
    def to_string(ref), do: Prima.ComponentRef.to_string(ref)
  end
end
