...
defmodule Prima.UUID7 do
  ...
  ## Usage
      ...
      iex> Prima.UUID7.generate()
      "018f3d3c-5b10-7abc-8def-123456789012"

      # Generate a prefixed ID
      iex> Prima.UUID7.generate_id("req")
      "req_018f3d3c-5b10-7abc-8def-123456789012"

      # Standard prefixes
      iex> Prima.UUID7.request_id()
      "req_018f3d3c-..."

      iex> Prima.UUID7.execution_id()
      "exec_018f3d3c-..."


      iex> Prima.UUID7.build_id()
      "build_018f3d3c-..."
  """
  ...
  ## Examples
      ...
      iex> id = Prima.UUID7.generate_id("req")
      iex> String.starts_with?(id, "req_")
      true

      iex> id = Prima.UUID7.generate_id("exec")
