...
defmodule Arca.CopyTreeTest do
  ...
  test "a file that vanishes between the walk and its read is skipped, not fatal" do
    ...
    Application.put_env(:arca, :storage_adapter, Arca.CopyTreeTest.VanishingAdapter)
  ...
  test "materializes bundle bytes through the configured adapter, reading seed in place", %{
    ...
    prev_adapter = Application.get_env(:arca, :storage_adapter)
    Application.put_env(:arca, :storage_adapter, Arca.CopyTreeTest.RecordingAdapter)
