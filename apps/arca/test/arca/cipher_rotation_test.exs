...
defmodule Arca.CipherRotationTest do
  ...
  describe "who may ask" do
    ...
    test "a map of tenancy fields or a bare id is not an actor and raises", %{actor: actor} do
      tenancy_map = %{athanor_id: @athanor, scope: :athanor}
      ...
      assert_raise FunctionClauseError, fn ->
        apply(Rotation, :page, [tenancy_map, :vault_entries, nil, 10])
      end
