defmodule Compendium.Edition do
  ...
  def core_edition? do
    sanctum_edition = Application.get_env(:sanctum, :edition, :community)
    arx_edition = Application.get_env(:sanctum_arx, :edition, :community)
    sanctum_edition != :arx and arx_edition != :arx
  end
