...
// Package serve is `cyfr-spawn serve`: it checks its own privileges, starts
...
const Usage = "cyfr-spawn serve --pool <name>:<first>-<last> [--pool …] --home-root <dir> --client-user <user> -- <command> [args…]"
