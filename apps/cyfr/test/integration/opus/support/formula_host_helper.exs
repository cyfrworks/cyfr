...
defmodule Opus.Test.FormulaHost do
  ...
  client reaches CYFR over the wire, through the integration suite's host
  bridge (`Cyfr.Test.Integration.Opus`). `current!/2` is the client of a
  formula a real run has attached.
  """
  ...
  def attached!(opts \\ []) do
    ...
    Map.put(
      ...
      Opus.HostClient.new(
        ...
        fixture.runner,
        fixture.boot,
        Cyfr.Test.Integration.Opus.host_url()
      )
    )
  end
