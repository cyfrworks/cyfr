defmodule SanctumArx.EditionTest do
  ...
  describe "core?/0" do
    test "returns true when in core mode" do
      assert Edition.core?() == true
    end

    test "returns false when in arx edition" do
      Application.put_env(:cyfr, :edition, :arx)
      assert Edition.core?() == false
    end
  end
  ...
  describe "feature_available?/1" do
    ...
    test "arx features are not available in core mode" do
  ...
  describe "feature_available?/1 unknown features" do
    test "unknown feature returns false" do
      assert Edition.feature_available?(:nonexistent) == false
    end

    test "unknown feature returns false even in arx mode" do
      Application.put_env(:cyfr, :edition, :arx)
  ...
  describe "available_features/0" do
    test "returns core features in core mode" do
  ...
  describe "core_features/0" do
    test "returns list of community features" do
      features = Edition.core_features()
