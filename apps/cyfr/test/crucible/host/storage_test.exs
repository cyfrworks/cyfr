...
defmodule Crucible.Host.StorageTest.GatedAdapter do
  @moduledoc false
...
defmodule Crucible.Host.StorageTest.AnsweringAdapter do
  @moduledoc false
  use Arca.Storage.TestDouble
...
defmodule Crucible.Host.StorageTest do
  @moduledoc """
  ...
  alias Crucible.Host.StorageTest.{AnsweringAdapter, GatedAdapter}
  ...
  describe "storage" do
    ...
    test "after a cancel or a takeover a write is lost and leaves no bytes" do
      ...
      assert {:ok, %{cancelled: true}} =
               Crucible.cancel(cancelled.ctx, cancelled.execution_id)
        ...
        for n <- 1..20 do
          ...
          canceller =
            Task.async(fn ->
              ...
              {:ok, %{cancelled: true}} = Crucible.cancel(fixture.ctx, fixture.execution_id)
