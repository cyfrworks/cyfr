...
defmodule Crucible.GuestStorageTest.UnreadableUsageAdapter do
  @moduledoc false
...
defmodule Crucible.GuestStorageTest do
  @moduledoc """
  ...
  alias Crucible.GuestStorageTest.UnreadableUsageAdapter
