defmodule PrismWeb.DashboardLive do
  ...
  def mount(_params, _session, socket) do
    if connected?(socket) do
      ...
      Phoenix.PubSub.subscribe(Emissary.PubSub, Sanctum.PubSub.topic("prism:system", ctx))
    ...
    # Trigger data loading for standalone mode.
    # In shell mode, ShellCompat on_mount sends :shell_init instead.
