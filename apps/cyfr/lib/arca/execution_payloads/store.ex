...
defmodule Arca.ExecutionPayloads.Store do
  ...
  `config :cyfr, :execution_payload_store` names the module. The shipped
  ...
  @spec impl() :: module()
  def impl,
    do: Application.get_env(:cyfr, :execution_payload_store, Arca.ExecutionPayloads.Store.Overlay)
end
