...
defmodule Arca.Cache.Keys do
  ...
  Every athanor-keyed shape takes the `Cyfr.Actor` first and reads the
  ...
  def live_shape(%Cyfr.Actor{athanor_id: athanor_id}, source_ref)
      when is_binary(athanor_id) and athanor_id != "",
      do: {:live_shape, athanor_id, source_ref}

  def live_shape(%Cyfr.Actor{}, _source_ref),
  ...
  def match_live_shape(%Cyfr.Actor{athanor_id: athanor_id})
      when is_binary(athanor_id) and athanor_id != "",
      do: {:live_shape, athanor_id, :_}

  def match_live_shape(%Cyfr.Actor{}),
  ...
  def component_meta(%Cyfr.Actor{athanor_id: athanor_id}, reference)
      when is_binary(athanor_id) and athanor_id != "",
      do: {:component_meta, athanor_id, reference}

  def component_meta(%Cyfr.Actor{}, _reference),
  ...
  def match_component_meta(%Cyfr.Actor{athanor_id: athanor_id})
      when is_binary(athanor_id) and athanor_id != "",
      do: {:component_meta, athanor_id, :_}

  def match_component_meta(%Cyfr.Actor{}),
  ...
  """
  def exec_events(%Cyfr.Actor{athanor_id: athanor_id}, execution_id)
      when is_binary(athanor_id) and athanor_id != "",
      do: {:exec_events, execution_id, athanor_id}

  def exec_events(%Cyfr.Actor{}, _execution_id),
    do: Arca.QueryHelpers.no_athanor!("Arca.Cache.Keys.exec_events/2")

  @doc "The external MCP tool map of an athanor."
  def external_tools(%Cyfr.Actor{athanor_id: athanor_id})
      when is_binary(athanor_id) and athanor_id != "",
      do: {:external_tools, athanor_id}

  def external_tools(%Cyfr.Actor{}),
  ...
  def athanor_usage(%Cyfr.Actor{athanor_id: athanor_id})
      when is_binary(athanor_id) and athanor_id != "",
      do: {:athanor_usage, athanor_id}

  def athanor_usage(%Cyfr.Actor{}),
  ...
  def scope_usage_bytes(%Cyfr.Actor{athanor_id: athanor_id}, scope)
      when is_binary(athanor_id) and athanor_id != "",
      do: {:scope_usage, athanor_id, scope, :bytes}

  def scope_usage_bytes(%Cyfr.Actor{}, _scope),
  ...
  def scope_usage_files(%Cyfr.Actor{athanor_id: athanor_id}, scope)
      when is_binary(athanor_id) and athanor_id != "",
      do: {:scope_usage, athanor_id, scope, :files}

  def scope_usage_files(%Cyfr.Actor{}, _scope),
  ...
  def match_scope_usage(%Cyfr.Actor{athanor_id: athanor_id})
      when is_binary(athanor_id) and athanor_id != "",
      do: {:scope_usage, athanor_id, :_, :_}

  def match_scope_usage(%Cyfr.Actor{}),
  ...
  """
  def tincture_scan_running(%Cyfr.Actor{athanor_id: athanor_id})
      when is_binary(athanor_id) and athanor_id != "",
      do: {:tincture_scan_running, athanor_id}

  def tincture_scan_running(%Cyfr.Actor{}),
