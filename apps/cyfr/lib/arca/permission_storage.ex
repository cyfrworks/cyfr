defmodule Arca.PermissionStorage do
  ...
  Permissions are org-level grants by design, not project-scoped. A permission
  granted to a subject applies across all projects within that org. Project-level
  enforcement happens at the `Sanctum.Context` authorization layer, not here.
  """
