...
defmodule Crucible.Delegation do
  @moduledoc """
  ...
  attempt (`Crucible.Attempt`); a runner's copy of the input is never
  read.
  ...
  defp same_component?(a, b) do
    case {Prima.ComponentRef.to_name_ref(a), Prima.ComponentRef.to_name_ref(b)} do
