...
defmodule Compendium.WasmValidator do
  @moduledoc """
  ...
  ## Usage
      ...
      {:ok, result} = Compendium.WasmValidator.validate(wasm_bytes)
      # => %{
      #      valid: true,
      ...
      {:error, reason} = Compendium.WasmValidator.validate(invalid_bytes)
