      ...
      %{
        ...
        annotations: %{
          ...
          actions: %{
            ...
            "claim_publisher" => %{kind: :write, planes: [:external, :in_chain]},
            "verify_publisher" => %{kind: :write, planes: [:external, :in_chain]},
            "tokens_list" => %{kind: :read, planes: [:external, :in_chain]},
            "tokens_issue" => %{kind: :write, planes: [:external, :in_chain]},
            "tokens_revoke" => %{kind: :write, planes: [:external, :in_chain]},
            "members_list" => %{kind: :read, planes: [:external, :in_chain]},
            "members_add" => %{kind: :write, planes: [:external, :in_chain]},
            "members_update" => %{kind: :write, planes: [:external, :in_chain]},
            "members_remove" => %{kind: :write, planes: [:external, :in_chain]},
