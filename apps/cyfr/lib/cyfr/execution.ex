...
defmodule Cyfr.Execution do
  ...
  decides (`Cyfr.Execution.Admission.root_edge/4`).
  ...
  claim the loop keeps (`t:Cyfr.Execution.TurnRoot.claim/0`).
  """
  ...
  execution can be cancelled. See `Cyfr.Execution.Dispatch.cancel/3`.
  """
