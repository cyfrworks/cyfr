...
defmodule Cyfr.Bus.PolicyDecision do
  @moduledoc """
  The athanor's enforcement log changed: a policy decision was recorded,
  on `Cyfr.Bus.enforcement/1`. Readers re-read the log.
  """

  alias Cyfr.Bus.Payload

  @kinds [:changed]
  @fields [:event_type, :decision, :component_ref]
