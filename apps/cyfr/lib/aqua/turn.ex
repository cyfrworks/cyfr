...
defmodule Aqua.Turn do
  ...
  @doc "The roster of the tape in focus (`Aqua.Roster.roster/1`)."
  @spec roster(Context.t()) :: [map()]
  defdelegate roster(ctx), to: Aqua.Roster

  @doc "The orchestrator an `@name` in a message picks (`Aqua.Roster.parse_mention/2`)."
  @spec parse_mention(String.t(), [map()]) :: {String.t(), map() | nil}
  defdelegate parse_mention(message, orchestrators), to: Aqua.Roster
