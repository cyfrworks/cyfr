...
defmodule Sanctum.DeviceFlowProvidersTest do
  ...
  setup do
    original = {
      ...
      Application.get_env(:sanctum, :google_client_secret)
    }
  ...
  defp put(key, nil), do: Application.delete_env(:sanctum, key)
  defp put(key, value), do: Application.put_env(:sanctum, key, value)
